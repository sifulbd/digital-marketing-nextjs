        ...
        <div className="container">
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-3 col-sm-6 mb-4">
              <div className="course">
                <div className="course-img">
                  ...
                  <a href="#" className="course-category"><i className="far fa-bookmark"></i> Business</a>
                </div>
                <div className="course-info">
                  <div className="course-title">
            ...
            <div className="col-lg-3 col-sm-6 mb-4">
              <div className="course">
                <div className="course-img">
                  ...
                  <span className="course-category"><i className="far fa-bookmark"></i> IT &amp; software</span>
                </div>
                <div className="course-info">
                  <div className="course-title">
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="course">
                <div className="course-img">
                  <img className="img-fluid" src="images/course/08.jpg" alt="" />
                  <a href="#" className="course-category"><i className="far fa-bookmark"></i> Business</a>
                </div>
                <div className="course-info">
                  <div className="course-title">
